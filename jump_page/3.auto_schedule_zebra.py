...
ct_df = pd.read_csv("/Users/liliguo/Desktop/github/SMS_Report/Daily_Reporting/Jumppage_Testing/Jump Page Testing Schedule.csv")
gc = pygsheets.authorize(service_account_file = filepath.service_account_location)
cobra = gc.open_by_url('https://docs.google.com/spreadsheets/d/12vqSDueybprNphtsw7gXR5vmgcPG6_5ZNcnWzNpiasY/edit#gid=1186670009')
...
ct_df['Creative'] = ct_df['Creative'].fillna("")
